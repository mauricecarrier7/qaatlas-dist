...
curl -L -o /usr/local/bin/qaatlas \
  https://github.com/mauricecarrier7/qaatlas-dist/releases/download/v2.2.2/qaatlas-macos
...
```bash
curl -L -o /usr/local/bin/qaatlas \
  https://github.com/mauricecarrier7/qaatlas-dist/releases/download/v2.2.2/qaatlas-linux-x64
chmod +x /usr/local/bin/qaatlas
```
...
```bash
curl -L -o /usr/local/bin/qaatlas \
  https://github.com/mauricecarrier7/qaatlas-dist/releases/download/v2.2.2/qaatlas-linux-arm64
chmod +x /usr/local/bin/qaatlas
```
...
jobs:
  analyze:
    ...
    steps:
      ...
      - run: npm install -g @synctek/qaatlas
...
```yaml
key: qaatlas-2.2.2-Linux-X64-v2
```
